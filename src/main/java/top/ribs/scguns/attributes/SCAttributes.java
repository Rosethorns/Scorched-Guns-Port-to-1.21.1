...
public class SCAttributes {
    ...
    public static final Holder<Attribute> PROJECTILE_SPEED = ATTRIBUTES.register("projectile_speed",
    ...
    //public static final Holder<Attribute> FIRE_RATE_MULTIPLIER = ATTRIBUTES.register("fire_rate_multiplier",
    //        () -> new RangedAttribute("attribute.scguns.fire_rate_multiplier", 0.0F, -1000.0F, 99.9F)
    //                .setSyncable(true)
    //);

    public static final Holder<Attribute> ADDITIONAL_BULLET_DAMAGE = ATTRIBUTES.register("additional_bullet_damage",
            () -> new RangedAttribute("attribute.scguns.additional_bullet_damage", 0.0, -1000, 10000.0)
                    .setSyncable(true)
    );

    public static final Holder<Attribute> RELOAD_SPEED = ATTRIBUTES.register("reload_speed",
            () -> new RangedAttribute("attribute.scguns.reload_speed", 1.0, 0.01, 1000.0)
                    .setSyncable(true)
    );

    public static final Holder<Attribute> BULLET_DAMAGE_MULTIPLIER = ATTRIBUTES.register("bullet_damage_multiplier",
    ...
    //public static final Holder<Attribute> BULLET_RESISTANCE = ATTRIBUTES.register("bullet_resistance",
    //        () -> new RangedAttribute("attribute.scguns.bullet_resistance", 0.0, 0, 100.0)
    //                .setSyncable(true)
    //);
    public static final Holder<Attribute> SPREAD_MULTIPLIER = ATTRIBUTES.register("spread_multiplier",
