...
public class ModContainers {
    ...
    public static final Holder<MenuType<AttachmentContainer>> ATTACHMENTS = register("attachments", AttachmentContainer::new);



    private static <T extends AbstractContainerMenu> Holder<MenuType<T>> register(String id, MenuType.MenuSupplier<T> factory) {
