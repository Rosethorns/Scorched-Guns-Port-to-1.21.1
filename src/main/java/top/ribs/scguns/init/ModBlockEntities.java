...
public class ModBlockEntities {
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES =
            DeferredRegister.create(NeoForgeRegistries.BLOCK_ENTITY_TYPES, "scguns");
    public static final Holder<BlockEntityType<GunShelfBlockEntity>> GUN_SHELF_BLOCK_ENTITY =
            BLOCK_ENTITIES.register("gun_shelf", () ->
                    BlockEntityType.Builder.of(GunShelfBlockEntity::new,
                            ModBlocks.GUN_SHELF.get()).build(null));
    public static final Holder<BlockEntityType<MobTrapBlockEntity>> MOB_TRAP =
            BLOCK_ENTITIES.register("mob_trap", () ->
                    BlockEntityType.Builder.of(MobTrapBlockEntity::new,
                            ModBlocks.MOB_TRAP.get()).build(null));
    public static final Holder<BlockEntityType<AdvancedComposterBlockEntity>> ADVANCED_COMPOSTER =
    ...
    public static final Holder<BlockEntityType<PolarGeneratorBlockEntity>> POLAR_GENERATOR =
    ...
    public static final Holder<BlockEntityType<PenetratorBlockEntity>> PENETRATOR =
    ...
    public static final Holder<BlockEntityType<MaceratorBlockEntity>> MACERATOR =
            BLOCK_ENTITIES.register("macerator", () ->
                    BlockEntityType.Builder.of(MaceratorBlockEntity::new,
                            ModBlocks.MACERATOR.get()).build(null));

    public static final Holder<BlockEntityType<PoweredMaceratorBlockEntity>> POWERED_MACERATOR =
    ...
    public static final Holder<BlockEntityType<MechanicalPressBlockEntity>> MECHANICAL_PRESS =
    ...
    public static final Holder<BlockEntityType<PoweredMechanicalPressBlockEntity>> POWERED_MECHANICAL_PRESS =
    ...
    public static final Holder<BlockEntityType<LightningBatteryBlockEntity>> LIGHTNING_BATTERY =
    ...
    public static final Holder<BlockEntityType<BasicTurretBlockEntity>> BASIC_TURRET =
    ...
    public static final Holder<BlockEntityType<AutoTurretBlockEntity>> AUTO_TURRET =
    ...
    public static final Holder<BlockEntityType<EnemyTurretBlockEntity>> ENEMY_TURRET =
    ...
    public static final Holder<BlockEntityType<ShotgunTurretBlockEntity>> SHOTGUN_TURRET =
    ...
    public static final Holder<BlockEntityType<ShellCatcherModuleBlockEntity>> SHELL_CATCHER_MODULE =
    ...
    public static final Holder<BlockEntityType<AmmoModuleBlockEntity>> AMMO_MODULE =
    ...
    public static final Holder<BlockEntityType<AmmoBoxBlockEntity>> AMMO_BOX =
            BLOCK_ENTITIES.register("ammo_box", () ->
                    BlockEntityType.Builder.of(AmmoBoxBlockEntity::new,
                            ModBlocks.AMMO_BOX.get()).build(null));
    public static final Holder<BlockEntityType<VentCollectorBlockEntity>> VENT_COLLECTOR = BLOCK_ENTITIES.register("vent_collector",
